...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-L-6yYtZc.mjs");
...
var manifest = {
	"0e23b552ff6ecad23c367f496da2eadbab438be27a8f1a7893e123f50c70f28b": {
		...
		importer: () => import("./sheets.functions-DB8fULIV.mjs")
	},
	...
	"b27b66c81e0bce6a7c2448eb0572d77194d967e9904cd9c71a7b1aa3cef6d66d": {
		...
		importer: () => import("./airtable.functions--LDUbEep.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B_z4lIoi.mjs"),
		import("./start-B2lzX_Jh.mjs"),
...
//#endregion
export { getServerFnById as i, createServerFn as n, TSS_SERVER_FUNCTION as r, server_exports as t };
