...
import { A as _getRenderedMatches, B as isNotFound, D as getStylesheetHref, E as getScriptPreloadAttrs, I as isRedirect, L as isResolvedRedirect, O as resolveManifestAssetLink, R as parseRedirect, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponseDetached, j as executeRewriteInput, k as resolveManifestCssLink, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as rootRouteId } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CZZS7H50.mjs");
...
var manifest = {
	"0e23b552ff6ecad23c367f496da2eadbab438be27a8f1a7893e123f50c70f28b": {
		functionName: "prepareSpreadsheet_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"32f65ef324f3951a881a96063bdc7be2026db7f5d3dd0b8089c4c0f0c924b817": {
		functionName: "createWorkSpreadsheet_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"4fed7e79f1f4319c2965dd35e83612163943687e7353f15e9a16fdccf36df9a9": {
		functionName: "replaceWorkLogRows_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"5f93a5ce45a08dbcf162d890b71239ddba6605e67c18c35716bb2d2636572985": {
		functionName: "readCategoryList_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"b27b66c81e0bce6a7c2448eb0572d77194d967e9904cd9c71a7b1aa3cef6d66d": {
		functionName: "syncRecordToAirtable_createServerFn_handler",
		importer: () => import("./airtable.functions-CKFz4XQO.mjs")
	},
	"c5097760a7b329cbe21433a673c956b8f5bf96fe88dea062afef55da53a743be": {
		functionName: "testGoogleSheetsConnection_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"e9c19062c988a91cee9f43ecdd8b781a892490ef5a741dc6c6fae4082cdf3473": {
		functionName: "appendWorkLogRows_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"f1215c2972e0315b59b13a39fad5015ca4a9e6a4e18b12302fdbeb6adee0c192": {
		functionName: "writeCategoryList_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	},
	"fa587fec76e47499ed040a5a589c570f766c47a042311ecad246e911c61f07cb": {
		functionName: "readWorkLogRows_createServerFn_handler",
		importer: () => import("./sheets.functions-ayRmqcQH.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C6zy0r1v.mjs").then((n) => n.t),
		import("./start-BWE4mUb_.mjs"),
...
//#endregion
export { TSS_SERVER_FUNCTION as a, createServerFn as i, createCsrfMiddleware as n, getServerFnById as o, createMiddleware as r, server_exports as t };
